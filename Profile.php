...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    LOGOUT</a>
          ...
          <li class="nav-item">
            <a class="nav-link asignUp" href="pjp.php">HOME</a>
          </li>
        </ul>
      <!--if login-->
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- textarea -->
                    <textarea name="textarea"placeholder=" Type your post here..." class="form-control txtPostModal" id="exampleFormControlTextarea1" rows="3">
...
// $sql="select * from posts join users on users.Id=posts.User_id ";
 ...
 //$sql="select * from posts join users on users.Id=posts.User_id";
 $sql="select * from posts join users on users.Id=posts.User_id where Id=$Id";
...
// echo '</table>';
    ...
    <div class="postCard">
        <div class="postForm">
            ...
            <div><h4> <?php echo $row['text'];  ?></h4> </div>
...
?>
                    ...
                    <input class="form-control" name="TextComment" type="text" placeholder="Type your comment" aria-label=".form-control-lg example">
                     <!-- <button  name="comt" type="submit" >Comment</button> -->
                     
                
                </div>
            </div></form>
            <a href="indexPost.php?idf=<?php
            echo $row['Post_Id'];
                     
                     // $_SESSION['id_p']=$row['Post_Id'];
                      //echo $_SESSION['id_p'];
                      ?>">  <?php  $row['Post_Id'];
